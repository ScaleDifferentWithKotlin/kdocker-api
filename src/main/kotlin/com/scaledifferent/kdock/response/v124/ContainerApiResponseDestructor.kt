...
class ContainerApiResponseDestructor: ResponseDestructor<ContainerApiResponse> {

    override fun destructJsonResponse(jsonString: String, apiType: ApiType): ContainerApiResponse {
